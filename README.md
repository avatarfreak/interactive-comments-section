...
Solution to the challenges using different tech stack. converting layout from image file to html file adhering to accessibility and sematic rules. Building interactive or dynamic activities using react framework Next js and typescript.

### Continued development

Will continue to build better product using web technologies.
